...
# codebook <- readRDS("../data/2-final/mhs_codebook.rds")
...
kc_tracts_2023 <- readRDS("../data/1-source/kc_tracts_2023.rds")
acs5_tract_2023 <- readRDS("../data/1-source/acs5_tract_2023.rds")
```
...
```{r}
kctracts <- st_transform(kc_tracts_2023, 4326)
kcpop <- acs5_tract_2023 |>
